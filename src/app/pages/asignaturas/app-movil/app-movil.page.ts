...
@Component({
  ...
  templateUrl: './app-movil.page.html',
  styleUrls: ['./app-movil.page.scss'],
})
export class AppMovilPage implements OnInit {
  ...
  ngOnInit() {
    ...
    if (alumnoAutenticado) {
      ...
      const asistenciaAlumno = asistencias.find(
        (a) => a.alumno === alumnoAutenticado.alumno && a.asignatura === 'appmovil'
      );
